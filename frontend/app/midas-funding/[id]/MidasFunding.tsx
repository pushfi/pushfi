...
import { useFetchMidasInforQuery } from "@/redux/slices/midas/midasApiSlice";

const Midasfunding = ({ id }: { id: any }) => {
    // fetch user

    const { data, refetch, error, isError, isFetching, isLoading } =
        useFetchMidasInforQuery({ id });
            ...
            <div className="flex w-full max-w-[600px] bg-white flex-col items-center">
                <div className="flex w-full flex-col items-center pt-8 p-6 ">
                    <img
                        ...
                        src={
                            "https://share1.cloudhq-mkt3.net/8a542db943b4f5.png"
                        }
                        alt=""
                    />
