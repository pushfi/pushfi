...
import { useFetchEmpireCapitalQuery } from "@/redux/slices/assessment-data/assessmentDataApiSlice";

const EmpireCapital = ({ id }: { id: any }) => {
    const { data, error, isFetching, isLoading } = useFetchEmpireCapitalQuery({
        id,
    });
