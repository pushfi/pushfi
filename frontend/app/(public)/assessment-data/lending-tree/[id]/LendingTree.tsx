...
import Image3 from "./asserts/lendingtree.png";
    ...
    <div className="bg-gray-100 font-sans text-gray-700">
      <div className="p-4 mx-auto max-w-[40rem]">
        <Image
          src={Image3}
          alt="HMB Logo Top"
          className=" w-[80%] max-w-[18rem] mx-auto"
        />
        <div className="mt-4 text-left">
          <p className="text-2xl font-normal ">
            Let&apos;s fund{" "}
            <span className="text-[#106beb] font-bold">Your Business</span>{" "}
            together!
          </p>
        </div>
        <div className="mt-4 text-left flex flex-col gap-6">
          ...
          <p className="mt-2">
            Great news! Your funding request has been successfully processed
            using our loan assessment system. We&apos;ve identified custom
            funding options tailored specifically for you.
          </p>
      ...
      <div className="bg-[#106beb] text-white  flex">
        <div className="flex w-full max-w-[40rem] mx-auto gap-4 p-4 flex-col md:flex-row items-center md:items-start">
          <Image src={Image2} alt="HMB Credit %" className="w-[8rem]  h-fit" />
          <div className="w-full flex flex-col gap-6 ">
            <h1 className="text-2xl font-bold">Credit Score Analysis:</h1>
            <p>
              TransUnion ={" "}
              <strong className="text-xl">{data?.transUnion}</strong>
            </p>
      ...
      <div className="p-4 max-w-[40rem] mx-auto flex flex-col gap-6 py-8 ">
        ...
        <div className="mt-4">
          ...
          <p>
            Minimum Estimated Range = <strong>{data.tMinRange}</strong>
          </p>
          <p>
            Maximum Estimated Range = <strong>{data.tMaxRange}</strong>
          </p>
          <p>
      ...
      <div className=" bg-white max-w-full">
        <div className="flex flex-col max-w-[40rem] mx-auto pb-8 p-4">
          ...
          <p>
            Minimum Estimated Range = <strong>{data.cMinRange}</strong>
          </p>
          <p>
            Maximum Estimated Range = <strong>{data.cMaxRange}</strong>
          </p>
          <p>
            Interest Rate Range ={" "}
      ...
      <div className="mx-auto p-4 text-center max-w-[40rem] gap-8 flex flex-col py-8">
        <h1 className="text-4xl font-bold text-gray-700">Ready to accept?</h1>
        <p className="mt-2 text-sm">
          After signing your loan agreement, you&apos;ll be able to track the
          progress of your loans through our <strong>PushFi</strong> client
          portal, ensuring ease of access and management.
        </p>
        <a
        ...
        <div className="mt-4 flex justify-center space-x-2">
          <a
            ...
            className="w-8 h-8"
          >
            <Image src={Image4} alt="Instagram" className="w-full h-full" />
          </a>
          <a
            ...
            className="w-8 h-8"
          >
            <Image src={Image5} alt="LinkedIn" className="w-full h-full" />
          </a>
          <a
            ...
            className="w-8 h-8"
          >
            <Image src={Image6} alt="Facebook" className="w-full h-full" />
          </a>
        </div>
        <Image src={Image7} alt="HMB Logo" className="mx-auto mt-4 w-36" />
      </div>
    </div>
  );
};
