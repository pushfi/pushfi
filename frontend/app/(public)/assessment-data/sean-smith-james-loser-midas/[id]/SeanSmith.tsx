...
import { useFetchSeanSmithJamesQuery } from "@/redux/slices/assessment-data/assessmentDataApiSlice";

const SeanSmith = ({ id }: { id: any }) => {
    const { data, error, isFetching, isLoading } = useFetchSeanSmithJamesQuery({
        id,
    });
