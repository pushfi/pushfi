...
const postSkywayMidas: RequestHandler = async (req, res) => {
    ...
    try {
        ...
        const message = await client.messages.create({
            body: `Dear ${req.body.name}, Your results from Skyway Funding Group are now available. Please visit ${process.env.DOMAIN}/assessment-data/skyway-midas/${response.fundindDataId} for details. Reply STOP to end`,
...
export default postSkywayMidas;
