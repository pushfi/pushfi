...
const postLendingTree: RequestHandler = async (req, res) => {
  ...
  try {
    ...
    const message = await client.messages.create({
      body: `Dear ${req.body.name}, Your results from HMB-LendingTree  are now available. Please visit ${process.env.DOMAIN}/assessment-data/lending-tree/${response.fundindDataId} for details. Reply STOP to end`,
...
export default postLendingTree;
