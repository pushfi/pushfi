...
const postSkyCraperCapital: RequestHandler = async (req, res) => {
    ...
    try {
        ...
        const message = await client.messages.create({
            body: `Dear ${req.body.name}, Your results from SkyScraper Capital are now available. Please visit ${process.env.DOMAIN}/assessment-data/skyscraper-capital/${response.fundindDataId} for details. Reply STOP to end`,
...
export default postSkyCraperCapital;
