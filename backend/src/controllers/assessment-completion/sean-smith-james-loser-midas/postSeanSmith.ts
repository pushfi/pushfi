...
const postSeanSmith: RequestHandler = async (req, res) => {
    ...
    try {
        ...
        const message = await client.messages.create({
            body: `Dear ${req.body.name}, Your results from Sean Smith are now available. Please visit ${process.env.DOMAIN}/assessment-data/sean-smith-james-loser-midas/${response.fundindDataId} for details. Reply STOP to end`,
